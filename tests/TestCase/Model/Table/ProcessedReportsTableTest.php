...
use App\Model\Table\ProcessedReportsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ProcessedReportsTable Test Case
 */
class ProcessedReportsTableTest extends TestCase
{
     ...
     */
    public $fixtures = [
        'app.processed_reports',
        'app.processed_ra_bills',
        'app.schemes',
        'app.projects',
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('ProcessedReports') ? [] : ['className' => 'App\Model\Table\ProcessedReportsTable'];
        $this->ProcessedReports = TableRegistry::get('ProcessedReports', $config);
    }
