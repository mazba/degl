...
use App\Model\Table\ProcessedReportTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ProcessedReportTable Test Case
 */
class ProcessedReportTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('ProcessedReport') ? [] : ['className' => 'App\Model\Table\ProcessedReportTable'];
        $this->ProcessedReport = TableRegistry::get('ProcessedReport', $config);
    }
