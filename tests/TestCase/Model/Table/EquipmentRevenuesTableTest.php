...
use App\Model\Table\EquipmentRevenuesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\EquipmentRevenuesTable Test Case
 */
class EquipmentRevenuesTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('EquipmentRevenues') ? [] : ['className' => 'App\Model\Table\EquipmentRevenuesTable'];
        $this->EquipmentRevenues = TableRegistry::get('EquipmentRevenues', $config);
    }
