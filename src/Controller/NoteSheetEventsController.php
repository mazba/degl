...
class NoteSheetEventsController extends AppController
{
    ...
    public function index()
    {
      ...
      //  echo "<pre>";print_r($user);die();
        $noteSheetEvents = $this->NoteSheetEvents->find('all', [
            'conditions' =>['NoteSheetEvents.recipient_designation_id' => $user['designation_id'],'NoteSheetEvents.office_id' => $user['office_id']],
            'contain' => ['Schemes', 'NoteSheetEntries', 'Offices']
        ]);
    ...
    public function view($id = null)
    {
        ...
        $user=$this->Auth->user();
       // echo "<pre>";print_r($user);die();
        $note_sheet_entries = $this->note_sheet_entries->find("all", [
