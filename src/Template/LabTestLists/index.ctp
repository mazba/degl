...
<div class="tabbable page-tabs">
    <ul class="nav nav-tabs">
        ...
        <li><?= $this->Html->link(__('Add Lab Test'), ['action' => 'add']) ?></li>
    </ul>
</div>
...
<script type="text/javascript">
    ...
    {
        var url = "<?php echo $this->request->webroot; ?>LabTestLists/ajax/get_grid_data";
        ...
        var source =
        {
            dataType: "json",
            dataFields: [
                { name: 'lab_test_group_name', type: 'string' },
...
//                selectionmode: 'checkbox',
                ...
                columns: [
                    { text: '<?= __('Group Name') ?>', dataField: 'lab_test_group_name',width:'20%'},
                    { text: '<?= __('Short Name') ?>', dataField: 'test_short_name_en',width:'20%'},
                    { text: '<?= __('Full Name') ?>', dataField: 'test_full_name_en',width:'30%'},
                    { text: '<?= __('Created Date') ?>', dataField: 'created_date',width:'10x%'},
