<div class="breadcrumb-line">
    <ul class="breadcrumb">
        ...
        <li class="active"><?= __('Lab Test Fee Registers') ?></li>
    </ul>
</div>
<div class="tabbable page-tabs">
    <ul class="nav nav-tabs">
        <li class="active"><?= $this->Html->link(__('List of Lab Test Fee Registers'), ['action' => 'index']) ?></li
    </ul>
</div>
...
<script type="text/javascript">
    ...
    {
        var url = "<?php echo $this->request->webroot; ?>LabTestFeeRegisters/ajax/get_grid_data";
        ...
        var source =
        {
            ...
            dataFields: [
                ...
                { name: 'schemes_or_work_description', type: 'string' },
...
//                selectionmode: 'checkbox',
                ...
                columns: [
                    ...
                    { text: '<?= __('Schemes/Work Description') ?>', dataField: 'schemes_or_work_description',width:'40%'},
        ...
        $(document).on("click", ".print", function(event)
        {
            ...
            $.ajax({
                url: '<?=$this->Url->build(('/LabTestFeeRegisters/print_it'), true)?>',
                type: 'POST',
                data:{
                    type:req_type,
