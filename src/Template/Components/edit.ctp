<div class="breadcrumb-line">
    <ul class="breadcrumb">
        ...
        <li class="active"><?= __('Edit Component') ?></li>
...
<div class="tabbable page-tabs">
    <ul class="nav nav-tabs">
        ...
        ?>
        <li class="active"><?=
            $this->Html->link(__('Edit Component'), ['action' => 'edit', $component->id
            ]) ?>
        </li>
        <?php
        if ($user_roles['delete'] == 1)
        {
            ...
            <li><?=
                $this->Form->postLink(
                    ...
                    ['confirm' => __('Are you sure you want to delete # {0}?', $component
                        ->name_en)]
                )
                ?>
            </li>
...
<div class="panel panel-default">
    ...
    <div class="panel-heading"><h6 class="panel-title"><i
                class="icon-paragraph-right2"></i><?= __('Edit Component') ?>
        </h6></div>
