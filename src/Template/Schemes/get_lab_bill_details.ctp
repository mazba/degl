<div id="myModal" class="modal myModal1 fade" tabindex="-1" role="dialog">
    <div class="modal-dialog" style="width: 800px !important;">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" id="child" class="btn btn-default child" data-dismiss="" data-target="#">Close</button>
<!--                <button type="button" class="close child" data-dismiss="modal" aria-hidden="true" data-toggle="modal" href="#myModal">&times;</button>-->
...
<!--                                            <td>--><?//= $labTest['number_of_test'] ?><!--</td>-->
                                            ...
                                            <td><?= $labTest['rate'] ?></td>
<!--                                            <td>--><?//= $labTest['total'] ?><!--</td>-->
                                            <td><?= $labTest['latest_total'] + $labTest['total'] ?></td>
                                        </tr>
                                    <?php } ?>
<!--                                    <tr>-->
<!--                                        <td>&nbsp;</td>-->
...
<!--                                    </tr>-->
                                    <tr style="background: #dcd8ce">
                                        <td class="text-right" colspan="4"><?= __('Total') ?></td>
                                        <td class="text-center" colspan="2"><?= array_sum(array_column($labTests, 'latest_total')) + array_sum(array_column($labTests, 'total')) ?></td>
                                    </tr>

<!--                                    <tr style="background: #dcd8ce">-->
<!--                                        <td class="text-right" colspan="5">--><?//='Test Fee Paid Up to Previous Bill Tk.' ?><!--</td>-->
<!--                                        <td class="text-center" colspan="2">--><?//=  array_sum(array_column($labTests, 'total')) ?><!--</td>-->
<!--                                    </tr>-->

                                    <tr style="background: #dcd8ce">
                                        <td class="text-right" colspan="4"><?='Net payable this bill Tk' ?></td>
                                        <td class="text-center" colspan="2"><?= (array_sum(array_column($labTests, 'latest_total')) + array_sum(array_column($labTests, 'total')))- array_sum(array_column($labTests, 'total')) ?></td>
                                    </tr>
