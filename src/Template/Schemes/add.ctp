                ...
                <div class="tab-content pill-content">
                    <div id="general" class="tab-pane fade active in">
                        ...
                        <div class="col-sm-6">
                            ...
                            echo $this->Form->input('contract_date', ['type' => 'text', 'class' => 'form-control hasdatepicker']);
                            ...
                            ?>
                            <div class="form-group input number">
                                <label class="col-sm-3 control-label text-right"><?= __('Sub Scheme Type') ?></label>
                                <div class="col-sm-9">
                            ...
                            <div class="panel-body col-sm-4">
                                <div class="form-group input text">
                                    ...
                                    <div class="col-sm-8 container_eve_approval_date">
                                        <input type="text" name="eve_approval_date" value="" id="eve-approval-date"
                                               maxlength="11"
                                               class="form-control hasdatepicker">
                                    </div>
                                </div>
