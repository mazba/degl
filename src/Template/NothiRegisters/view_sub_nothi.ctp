...
<div class="tabbable page-tabs">
    <ul class="nav nav-tabs">
        ...
        <li class="active"><?= $this->Html->link(__('List of Sub Nothi'), ['action' => 'view_sub_nothi']) ?></li>
        <?php
        if ($user_roles['add'] == 1) {
            ?>
...
<div class="nothiRegisters index panel panel-default">
    <div class="panel-heading"><h6 class="panel-title"><i class="icon-table"></i> <?= __('List of Sub Nothi') ?>
        </h6>
    </div>
    <div class="datatable">
        <table class="table">
                ...
                <tr>
                    ...
                    <td class="actions">
                        ...
                        if ($user_roles['view'] == 1) {
                            if(!empty($nothiRegister->parent_nothi)){
                                ...
                                echo $this->Html->link('<button class="btn btn-primary btn-icon" type="button"><i class="icon-newspaper"></i></button>', ['action' => 'view', $nothiRegister->id
                                    , '_full' => true], ['escapeTitle' => false, 'title' => 'Details']);
                            }
