...
<div class="breadcrumb-line">
    <ul class="breadcrumb">
        ...
        <li class="active"><?= __('Edit Tree Plant') ?></li>
...
<div class="tabbable page-tabs">
    <ul class="nav nav-tabs">
        ...
        ?>
        <li class="active"><?= $this->Html->link(__('Edit Tree Plant'), ['action' => 'edit', $treePlant->id
            ]) ?>
        </li>
    ...
    <div class="panel-body col-sm-12">
        ...
        <div class="col-sm-12" style="margin-top:15px">
            <div class="row panel panel-default">
                ...
                <div class="panel-body col-sm-6">
                    <?php
                    echo $this->Form->input('alive_bonoz',['label'=>__('Bonoz')]);
                    echo $this->Form->input('alive_vesoz',['label'=>__('Vesoz')]);
                    ?>
                </div>

                <div class="panel-body col-sm-6">
                    <?php
                    echo $this->Form->input('alive_foloz',['label'=>__('Foloz')]);
                    ?>
                </div>
            </div>
        </div>
