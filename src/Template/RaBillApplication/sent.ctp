...
<div class="tabbable page-tabs">
    <ul class="nav nav-tabs">
        ...
        <li class="active"><?= $this->Html->link(__('Sent'), ['action' => 'sent']) ?></li>
        <li><?= $this->Html->link(__('Create New RA Bill'), ['action' => 'add']) ?></li>
...
<script type="text/javascript">
    ...
    {
        var url = "<?php echo $this->request->webroot; ?>RaBillApplication/ajax/sent";
