...
<div class="breadcrumb-line">
    <ul class="breadcrumb">
        ...
        <li><?= $this->Html->link(__('Guard Files'), ['action' => 'index']) ?> </li>
        <li class="active"><?= __('Detail Guard File') ?> </li>
    </ul>
</div>
<div class="tabbable page-tabs">
    <ul class="nav nav-tabs">
        <li><?= $this->Html->link(__('List of Guard Files'), ['action' => 'index']) ?> </li>

        <li class="active"><?=
            $this->Html->link(__('Details Guard Files'), ['action' => 'view', $receiveFileRegister->id
            ]) ?>
        </li>
    </ul>
</div>
