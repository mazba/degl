...
<div class="breadcrumb-line">
    <ul class="breadcrumb">
        ...
        <li class="active"><?= __('New Lab Test Frequency') ?></li>
...
<div class="tabbable page-tabs">
    <ul class="nav nav-tabs">
        ...
        <li class="active"><?= $this->Html->link(__('New Lab Test Frequency'), ['action' => 'add']) ?></li>
...
<div class="row panel panel-default">
    ...
    <div class="panel-heading"><h6 class="panel-title"><i
                class="icon-paragraph-right2"></i><?= __('Add Lab Test Frequency') ?>
        </h6></div>
