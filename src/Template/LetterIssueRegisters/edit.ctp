...
<div class="breadcrumb-line">
    <ul class="breadcrumb">
        ...
        <li><?= $this->Html->link(__('Letter Issue Registers'), ['action' => 'index']) ?></li>
                    <li class="active"><?= __('Edit Letter Issue Register') ?></li>
...
<div class="tabbable page-tabs">
    <ul class="nav nav-tabs">
        <li><?= $this->Html->link(__('List of Letter Issues'), ['action' => 'index']) ?></li>
            ...
            ?>
            <li class="active"><?= $this->Html->link(__('Edit Letter Issue'), ['action' => 'edit', $letterIssueRegister->id
                ]) ?>
            </li>
            <?php
            if ($user_roles['delete'] == 1)
            {
                ...
                <li><?=
                    $this->Form->postLink(
                        __('Delete Letter Issue'),
                        ['action' => 'delete', $letterIssueRegister->id],
                    ['confirm' => __('Are you sure you want to delete # {0}?', $letterIssueRegister
                    ->id)]
                    )
                    ?>
                </li>
            ...
            {
                ?>
                <li><?= $this->Html->link(__('Details Letter Issue'), ['action' => 'view', $letterIssueRegister->id])
                    ?>
                </li>
            <?php
            }
