...
<div class="well text-center">
  ...
  if ($user_roles['print_it']) {
    ?>
    <button class="print btn btn-info" type="button" data-print="today">
      <i class="icon-print2"></i><?= __('Print Today') ?></button>
    <a data-toggle="modal" role="button" href="#small_modal">
      <button class="btn btn-success" type="button"><i class="icon-print"></i><?= __('Print By Date Range') ?></button>
    </a>
    <?php
  }
  ?>
...
//                selectionmode: 'checkbox',
        ...
        columns: [
          ...
          {text: '<?= __('Actions') ?>', cellsalign: 'left', dataField: 'action', width: '8%'}
        ]
      });
