            ...
            <div style="display: block" class="col-sm-12">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <th rowspan="2"  style="vertical-align: top; width: 160px !important;" class="text-center"><?php
                            if(isset($finalcialYearData)){
                                echo $this->Common->EngToBanglaNum($finalcialYearData['name']);
                            }else{
                                echo '....';
                            }
                            ?> অর্থ বছরে পূর্তকাজের মোট ব্যয় (লক্ষ টাকায়) (ব্রীজ, কালভার্ট, সড়ক, হাট-বাজার)</th>
                    ...
                    <tbody class="test_list">
                        <tr>
                            ...
                            <td class="text-center"><?php ?><?= $this->Number->format($vehicleCostResult['service_charge']) ?></td>
                            <td class="text-center"><?php ?><?= $this->Number->format($hireChargeResult['total_amount']) ?></td>
